...
main() {
  ...
  warn "Anonymity-by-default profile assumes Tor is running on 127.0.0.1:9050."
  warn "Without Tor, fresh ztox profiles will not connect — disable in Settings → Advanced → Proxy."
  echo
